...
struct CdmCylinderKnockState {
    ...
    // Argument arrays for static trampoline callbacks — [0]=this, [1]=cylIndex
    uintptr_t windowOpenArg[2]  = {};
    uintptr_t windowCloseArg[2] = {};
...
public:
    ...
    // ---- ISR callbacks — public so file-scope EXTI trampolines can call them ----
